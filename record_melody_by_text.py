...
def save_melody(save_melody_popup_window, melody_input_field, melody_name_input_field, melody_keywords_input_field,
                menu):
    try:
...
def save_melody_popup_window(app):
    ...
    Example: F#4 E3 A#4"""
    rules_button = tk.Button(save_melody_popup_window, text='Rules',
                             command=lambda: [popup_windows.popup_window(save_melody_popup_window, rules, "Continue")])
    rules_button.pack()

    melody_label = tk.Label(save_melody_popup_window, text="Melody:")
    melody_label.pack()

    melody_input_field = tk.Text(save_melody_popup_window, height=MELODY_NAME_INPUT_FIELD_HEIGHT,
    ...
    save_melody_button = tk.Button(save_melody_popup_window, text="Save melody", command=lambda: [
        save_melody(save_melody_popup_window, melody_input_field, melody_name_input_field, melody_keywords_input_field,
                    menu)])
