...
class RegistrationFrame:
    def __init__(self, app):
        ...
        self.create_registration_fields(self.registration_frame)
    ...
    def register(self, registration_frame, username_input_field, password_input_field, confirm_password_input_field, 
    ...
    def create_registration_fields(self, registration_frame):
        ...
        role_dropdown = tk.OptionMenu(registration_frame, menu, "User with global rights", "User with local rights", command=lambda _ : self.create_registration_fields_for_global_user(menu, motivation_label, motivation_input_field, email_label, email_input_field))
        role_dropdown.pack()

        register_button = tk.Button(registration_frame, text="Register", 
                        command=lambda:[self.register(registration_frame, username_input_field, password_input_field, confirm_password_input_field, 
                        first_name_input_field, last_name_input_field, menu, motivation_input_field, email_input_field)])
