...
def create_login_fields(login_frame, registration_frame, virtual_piano_frame, admin_frame):
    ...
    login_button = tk.Button(login_frame, text='Login', command=lambda:[change_frame_after_login(login_frame, virtual_piano_frame, admin_frame, username_input_field, password_input_field)])
    login_button.pack()