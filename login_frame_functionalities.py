...
class LoginFrame:
    ...
    def create_fields(self, registration_frame, virtual_piano_frame, admin_frame):
        ...
        login_button = tk.Button(self.login_frame, text='Login', command=lambda:[self.change_frame_after_login(virtual_piano_frame.virtual_piano_frame, admin_frame.admin_frame, username_input_field, password_input_field)])
        login_button.pack()
